...
socketServer.on("connection", (socket) => {
    socket.on(Event.CREATE_ROOM, (user) => {
        console.log(ROOMS);
    ...
    socket.on(Event.JOIN_ROOM, (user) => {
        socket.join(user.roomId);
    ...
    socket.on(Event.SEND_VOTE, (user) => {
        const users = ROOMS.get(user.roomId);
